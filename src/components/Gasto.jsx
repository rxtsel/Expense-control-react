...
import IconoAlimentos from '../img/icono_alimentos.svg'
        ...
        <div className='gasto sombra'>
          <div className='contenido-gasto'>
            <img
              ...
              alt='puede ser una imagen de un icono relacionado con la categoria seleccionada'
            />
            <div className='descripcion-gasto'>
              <p className='categoria'>{categoria}</p>
              <p className='nombre-gasto'>{nombre}</p>
              <p className='fecha-gasto'>Añadido el: <span>{formatearFecha(fecha)}</span></p>
            </div>
          </div>
